...
if (isset($_GET['delete']) && is_numeric($_GET['delete'])) {
    ...
    try {
        ...
        // Удаляем связанные языки и пользователя, затем заявку (каскадно)
                ...
                <?php foreach ($submissions as $sub): ?>
                    <tr>
                        ...
                        <td class="actions">
                            ...
                            <a href="?delete=<?= $sub['id'] ?>" class="delete-btn" onclick="return confirm('Удалить запись #<?= $sub['id'] ?>?')">🗑️ Удалить</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php endif; ?>
