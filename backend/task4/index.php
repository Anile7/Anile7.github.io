...
<head>
    <meta charset="UTF-8">
    <title>Задание 4 – Анкета с валидацией</title>
    <style>
        /* --- Стили из задания 3 (полностью) --- */
        body {
...
<main>
    ...
    <form method="post" action="">
        ...
        <div class="form-group">
            <label>
                <input type="checkbox" name="contract" value="1" <?= (isset($old_input['contract']) && $old_input['contract'] == 1) ? 'checked' : '' ?>>
